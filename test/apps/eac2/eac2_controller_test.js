...
define([
  ...
  'apps/eac2/eac2_controller',
], function (Backbone, Marionette, helpers, Eac2Controller) {
  var dummyData = [{
  ...
  describe('Eac2Controller', function () {
    beforeEach(function () {
      ...
      this.controller = new Eac2Controller({region: this.region});
