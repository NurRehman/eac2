...
define(['marionette',  'apps/workpackage/workpackage_item_view', 'apps/workpackage/workpackage_button_item_view', 'apps/workpackage/workpackage_desc_item_view'], function (Marionette, WorkpackageItemView, WorkpackageBtnView, WorkpackageDescView) {
  ...
  return Marionette.Object.extend({
    ...
    workPackageContents1: function() {
      ...
      this.region.descriptionReg.show(new WorkpackageDescView());
